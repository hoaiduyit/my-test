...
export const addUsernameToFetch = (token) => ({ type: types.ADD_USERNAME_TO_FETCH, token });
...
export const actionOnArticle = (articleId, token, key, username) => ({ type: types.LIKE_UNLIKE_ARTICLE, articleId, token, key, username });

export const changePage = (itemPerPage, offset) => ({ type: types.CHANGE_PAGE, itemPerPage, offset });